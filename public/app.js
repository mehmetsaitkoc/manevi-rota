...
const paceLabel=id=>({gentle:'Yavaş ve sürdürülebilir',balanced:'Dengeli',deep:'Derinleşmeye açık'}[id]||id||'—');
const blockerLabel=id=>({time:'Vakit',forget:'Unutmak',start:'Başlamak',overload:'Fazla hedef',variable:'Değişken günler',none:'Belirgin engel yok'}[id]||id||'—');
