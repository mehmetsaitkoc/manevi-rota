...
assert.equal(kurandanAyetler.source?.normalizationVersion,4);
...
assert.doesNotMatch(kurandanAyetler.pages[0].text,/Kur W onum|Kur'ao|Mehmet Akilde|Kur an|Kuranı|Hazret\*/);
