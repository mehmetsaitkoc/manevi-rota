...
import {emptyQuranReaderState,normalizeQuranReaderState,quranVerseKey,quranVerseHighlight,quranVerseNote,toggleQuranVerseHighlight,setQuranVerseNote} from '../src/quran-reader.mjs';
...
const migrated=normalizeQuranReaderState({surah:999,ayah:0,fontScale:9,focusMode:1,highlightColor:'#8FC7A2',highlights:{'2:5':'#D998A2',bad:'red'},notes:{'2:5':'  kişisel not  ','x':'sil'}});
