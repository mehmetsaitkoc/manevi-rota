...
assert.equal(siyer.sourceGate?.ingest?.manifest,'sources/asri-saadet-1928/manifest.json');
assert.equal(siyer.sourceGate?.ingest?.auditCommand,'npm run asri:audit');
assert.equal(siyer.sourceGate?.ingest?.buildCommand,'npm run asri:build');
assert.equal(siyer.sourceGate?.ingest?.outputAsset,'public/data/books/asri-saadet-siyret.json');
assert.equal(siyer.sourceGate?.ingest?.failClosed,true);
