...
export const STARTER_LIBRARY=[
  {
      order:1,stage:'level-1',id:'yavrularimiza-din-dersleri',title:'Yavrularımıza Din Dersleri',author:'Ahmed Hamdi Akseki',field:'Temel din eğitimi',level:'Seviye 1',
  ...
  {
      order:3,stage:'level-2',id:'quran',title:'Kur’ân-ı Kerîm',author:'—',field:'Kur’ân',level:'Seviye 2',
