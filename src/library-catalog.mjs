...
export const STARTER_LIBRARY_STAGES=[
  {id:'level-1',order:1,title:'Temel Din Bilinci',subtitle:'İman, ibadet ve günlük Müslüman hayatı için sağlam bir temel kur.'},
  {id:'level-2',order:2,title:'Kur’ân ve İbadet Bilinci',subtitle:'Okuduğun ve namazda söylediğin sözlerin mânasıyla bağ kur.'},
...
export const STARTER_LIBRARY=[
  {
      order:1,stage:'level-1',id:'yavrularimiza-din-dersleri',title:'Yavrularımıza Din Dersleri',author:'Ahmed Hamdi Akseki',field:'Temel din eğitimi',level:'Başlangıç',
  ...
  {
      order:2,stage:'level-1',id:'islam-dini',title:'İslâm Dini',author:'Ahmed Hamdi Akseki',field:'İtikat · İbadet · Ahlâk',level:'Başlangıç',
  ...
  {
      order:3,stage:'level-2',id:'quran',title:'Kur’ân-ı Kerîm',author:'—',field:'Kur’ân',level:'Başlangıç',
  ...
  {
      order:4,stage:'level-2',id:'namaz-sureleri-tefsiri',title:'Namaz Sûrelerinin Türkçe Terceme ve Tefsiri',author:'Ahmed Hamdi Akseki',field:'Kur’ân · Namaz',level:'Başlangıç',
  ...
  {
      order:5,stage:'level-3',id:'kirk-hadis',title:'Kırk Hadis',author:'İmam Nevevî',field:'Hadis',level:'Başlangıç',
  ...
  {
      order:6,stage:'level-3',id:'peygamberimiz-muhammed',title:'Peygamberimiz Hz. Muhammed ve Müslümanlık',author:'Ahmed Hamdi Akseki',field:'Siyer',level:'Başlangıç',
  ...
  {
      order:7,stage:'level-4',id:'muslumanlik-nedir',title:'Müslümanlık Nedir?',author:'Ömer Rıza Doğrul',field:'İman · Temel esaslar',level:'Başlangıç',
  ...
  {
      order:8,stage:'level-4',id:'ahlak-dersleri',title:'Ahlâk Dersleri',author:'Ahmed Hamdi Akseki',field:'Ahlâk',level:'Başlangıç +',
  ...
  {
      order:9,stage:'level-5',id:'peygamberimizin-vecizeleri',title:'Peygamberimizin Vecizeleri',author:'Ahmed Hamdi Akseki',field:'Hadis · Ahlâk',level:'Başlangıç',
  ...
  {
      order:10,stage:'level-5',id:'vel-asr-tefsiri',title:'Ve’l-Asr Sûresinin Tefsiri',author:'Ahmed Hamdi Akseki',field:'Tefsir',level:'Başlangıç',
